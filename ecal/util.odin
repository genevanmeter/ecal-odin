...
foreign lib {
	...
	**/
	Util_GeteCALDataDir :: proc() -> cstring ---
	...
	*          The returned null-terminated string needs to be released by eCAL_Free().
	**/
	Util_GeteCALLogDir :: proc() -> cstring ---
	...
	**/
	Util_ShutdownProcess :: proc(unit_name_: cstring) ---
	...
	**/
	Util_ShutdownProcessId :: proc(process_id_: c.int) ---

	/**
	* @brief Send shutdown event to all local user processes.
	**/
	Util_ShutdownProcesses :: proc() ---
}
